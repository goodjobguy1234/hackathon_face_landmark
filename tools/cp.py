"""
Control Panel
use to call prototype commands

Sample: https://likegeeks.com/python-gui-examples-tkinter-tutorial/
"""
import time
from tkinter import *
...
prototype_py_file = "prototype.py"
...
class App(Frame):
    def __init__(self):
        ...
        heading = Label(root, text="DiagFirst",font=("Arial Bold", 20))
        ...
        self.btn_open_file = Button(optionFrame, text="Open Video Clip", command=self.openVideoFile,state=DISABLED)        
    ...
    def openVideoFile(self):
        vdo_file_name = filedialog.askopenfilename(filetypes = (("MP4 files","*.mp4"),("AVI files","*.avi")))        
